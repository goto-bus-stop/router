...
use crate::error::FederationDiagnostic;
...
fn operation_for_entities_fetch(
    ...
    let query_type_name = subgraph_schema
        ...
        .ok_or_else(|| FederationDiagnostic::NoQueryRoot)?;
    ...
    let query_type = match subgraph_schema.get_type(query_type_name.clone())? {
        ...
        _ => {
            return Err(FederationDiagnostic::RootOperationObjectType {
    ...
    {
        return Err(FederationDiagnostic::NoEntities {
            query_type: query_type_name.clone(),
        }
        .into());
    }
