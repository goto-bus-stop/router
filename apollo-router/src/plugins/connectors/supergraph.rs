...
mod tests {
    ...
    fn it_works() {
        ...
        [
            ...
            "CONNECTOR_QUERY_HELLOWITHHEADERS_4",
            "CONNECTOR_QUERY_HELLO_3",
            "CONNECTOR_QUERY_INTERFACES_6",
            "CONNECTOR_QUERY_INTERNAL_DEPENDENCIES_8",
            "CONNECTOR_QUERY_UNIONS_7",
            "CONNECTOR_QUERY_WITHARGUMENTS_5",
            "CONNECTOR_TESTINGINTERFACEOBJECT_2",
            "CONNECTOR_TESTINGINTERFACEOBJECT_D_9",
            "CONNECTOR_TESTINTERNALDEPENDENCY_C_10",
            "CONNECTOR_TESTREQUIRES_SHIPPINGCOST_11",
        ]
        "###
        );
    }
